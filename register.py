...
#             try:
#                 mydb = mysql.connector.connect(host='localhost',user='root',password='sanket30')
...
#                 mydb= mysql.connector.connect(host='localhost',user='root',password='sanket30',database="heart_data")
#                 mycursor =mydb.cursor()
    ...
    if (username == "" or username == "UserID") or (password == "" or password == "Password"):
        ...
        if password == confirm_password:
            try:
                ...
                mycursor.execute("CREATE TABLE IF NOT EXISTS login (user int auto_increment key not null, Username varchar(50), Password varchar(100))")
